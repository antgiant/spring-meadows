...
//echo "</div>";
      ...
      ?>
<div id="superGraphic"><img alt="A Caring Church" src="/site/1/template/images/1_A_Caring_Church.jpg" /></div>
...
<p>I look forward to meeting each of you,</p>

<p>With Christian love,</p>
...
<p id="directions"><?php 
                    ...
                    if(isset($ver[2]) && $ver[2] >= 6) {
                      Echo '			<a href="http://maps.apple.com/maps?daddr='.$dest.'"><img src="/site/1/images/directions.jpg" /></a>';
                    } 
                    else {
                      Echo '			<a href="http://maps.google.com/maps?saddr=&amp;daddr='.$dest.'"><img src="/site/1/images/directions.jpg" /></a>';
                    }
                  ?></p>
</div>
...
<p><a href="http://www.springmeadows.org/article/92/rejoice/sermons">Past Sermons</a></p>

<h3><span style="font-family:georgia,serif">Latest Blog Posts</span></h3>
<span style="font-family:georgia,serif">##rssdigest15##</span></div>

<div class="third" style="margin-right: 0px; border-right-width: 0px;">
<h3>In the next few days...</h3>
##calendar## ##calendarlist##

<h3>Connect</h3>

<div id="socialIcons"><a href="http://www.facebook.com/pages/Spring-Meadows-Seventh-day-Adventist-Church/252734141407822"><img alt="Facebook Icon" src="/site/1/template/images/social/facebook.png" /></a> <a href="http://twitter.com/meadows_sda"><img alt="Twitter Icon" src="/site/1/template/images/social/twitter.png" /></a> <a href="http://youtube.com/springmeadowssda"><img alt="Youtube Icon" src="/site/1/template/images/social/youtube.png" /></a> <a href="http://www.springmeadows.org/rss.php?zone=default"><img alt="RSS Icon" src="/site/1/template/images/social/rss.png" /></a> <a href="javascript:void(location.href='mailto:'+String.fromCharCode(111,102,102,105,99,101,64,115,112,114,105,110,103,109,101,97,100,111,119,115,46,111,114,103))"><img alt="Email Icon" src="/site/1/template/images/social/email.png" /></a></div>
</div>
</div>
